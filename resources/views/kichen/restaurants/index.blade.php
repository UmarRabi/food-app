                ...
                <div class="card-body">
                    ...
                    <div class="icons text-left">
                        ...
                        <div class="row" style="width: 100%;">
                            ...
                            <div class="col-md-8"
                                style="padding-top: 80px; margin-left:20px; padding-right: 40px; padding-left: 30px; padding-bottom: 80px; justify-content: center;  border-radius: 8px; margin-bottom: 100px; margin-top: 30px">
