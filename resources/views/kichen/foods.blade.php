...
@section('content')
    ...
    <div class="card">
        <div class="card-head">
            <a href="{{ route('food.form') }}" class="btn btn-blue">
                New
            </a>
        </div>
        <div class="card-body d-flex justify-content-center" style="overflow: scroll">
            <div class="row justify-content-center">
                @foreach ($foods as $food)
                    <div class="col-12">
                        <div class="rows">
                            <div class="list-label col-2 ml-3">
                                <a href="{{ route('food.edit', ['id' => $food->id]) }}" class="btn btn-blue">
                                    {{ $food->name }}
                                </a>
                            </div>
                            <div class="col-2">
                            ...
                            <div class="col-2">
                                {{ $food->scoked ? 'Stocked' : 'Out of Order' }}
                            </div>
                        </div>
