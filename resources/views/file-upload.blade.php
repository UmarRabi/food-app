...
@section('content')
    <div class="div">
        @include('_partials.white-header', [($text = 'Share Files')])
    </div>
    @include('_partials.search')
    <div class="div2">
        <div class="file-upload-section">
            <div class="download-text btn">Download Files</div>
        ...
        <div class="settings">
            <svg class="icons btn" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" xml:space="preserve"
            ...
            <svg class="icons btn" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
            ...
            <svg class="icons btn" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
