...
@section('content')
    <div class="rows container mt-5 pt-5 d-flex justify-content-start" style="margin-left: 30px">
    ...
    <div class="row d-flex justify-content-center" style="margin: 30px">
        <div class="col-6">
            <div class="curve-option-2" onclick="window.location.href={{ route('foods') }}"
                ...
                <a href="{{ route('foods') }}" class="fresh red-label" style="margin-top:8%;">Foods</a>
            </div>
        </div>
    </div>
    <div class="row d-flex justify-content-center" style="margin: 30px">
        <div class="col-6">
            <div class="curve-option-2" onclick="window.location.href={{ route('transactions') }}"
                style="display:grid; justify-items :center;">
                <a href="{{ route('transactions') }}" class="fresh red-label" style="margin-top:8%;">Orders</a>
            </div>
        </div>
    </div>
@endsection
